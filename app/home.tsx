      ...
      <SafeAreaView style={tw`flex-1 mt-4`}>
        ...
        <View style={tw`mx-5 mt-0`}>
          <View style={tw`mt-5 flex-row justify-center item-center rounded-full p-1 bg-[#e6e6e6]`}>  
            <TextInput placeholder='Search' style={tw`flex-1 font-sembibold text-gray-700`}/>
        ...
        <View style={{
          ...
          top:150
            ...
            {/* style={tw`flex-row justify-center mt-14`} */}
                {/* <Image source={product.image} style={tw`h-40 w-40`}></Image> */}
                <Image source={require('../assets/images/home/home4.png')} style={{width:150, height:150, left:26,bottom:60}}/>
            </View>
        ...
        <View style={{
          ...
          top:150
            ...
            {/* style={tw`flex-row justify-center mt-14`} */}
                {/* <Image source={product.image} style={tw`h-40 w-40`}></Image> */}
                <Image source={require('../assets/images/pizzza.png')} style={{width:150, height:150, left:26,bottom:60}}/>
            </View>
